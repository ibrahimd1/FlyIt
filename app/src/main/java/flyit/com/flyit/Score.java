...
public class Score {
	...
	public Score(float pX, float pY, TiledTextureRegion pTiledTextureRegion,
		...
		this.x = pX;
		this.y = pY;
		hundredNum = new AnimatedSprite(x - mNumberTiledTextureRegion.getWidth(),
				                        y, mNumberTiledTextureRegion,mVertexBufferObjectManager);
		tenNum = new AnimatedSprite(x, y, mNumberTiledTextureRegion, mVertexBufferObjectManager);
		bitNum = new AnimatedSprite(x + mNumberTiledTextureRegion.getWidth(),
				                    y, mNumberTiledTextureRegion,mVertexBufferObjectManager);
